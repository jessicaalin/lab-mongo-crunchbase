// to import companies.json to mongo: 
...
mongoClient.connect(url, (error, db) => {
  ...
  // supposed to delete the following block:
  // if (error) {
        ...
        switch(option){
          case "1": // List by name all companies.
            db.collection('companies').find({}, {name: 1, _id: 0}).toArray((error, result) => {
              ...
              // } else {
              //   result.forEach( (company, index) => { console.log(`${index}.- ${company.name}`) } );
              //   rl.question(`\nType enter to continue: `, (answer) => {mainMenu()});	
              // }
              if (error) {
                console.log(error);
          ...
          db.collection('companies').count({}, (error, result) => {
            ...
            break;
           case "3": // How many compaies were founded in 2004?
           db.collection('companies').count({"founded_year" : 2004}, (error, result) => {
            ...
            break;
          case "4": // List all companies founded in February of 2004.
          ...
          //       console.log(`Company: ${company.name}; Month Founded: ${company.founded_month}`);
          //     })
          //     rl.question(`\nType enter to continue: `, (answer) => {mainMenu()});
          //   }
          //  });
          if (error) {
           ...
           break;
           case "5": // List all companies founded between April and June
